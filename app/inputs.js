...
const handleFileInput = (event) => {
  ...
  var label = document.querySelector(`label[for=${event.currentTarget.getAttribute('id')}]`);
  ...
  Object.keys(hash).forEach(function (key) {
    ...
    var reference_node = event.currentTarget.previousElementSibling;
    var new_content    = document.createTextNode(`${hash[key].name}`);
    var delete_content = document.createTextNode('✖️');
